...
@arangates arangates
 ...
 Watch 107
  ...
  Fork 347
bear/python-twitter
 branch: master  python-twitter/examples/tweet.py
Radradlws on Dec 30, 2014 PEP8 code refactoring
4 contributors RadBernardo SulzbachWenyi HuangMike Taylor
RawBlameHistory     Executable File  150 lines (113 sloc)  4.45 kb
#!/usr/bin/env python
...
class TweetRc(object):
    ...
    def GetConsumerKey(self):
        return self._GetOption('boQCy1bo4vo87dGyvpnwbbQyS')

    def GetConsumerSecret(self):
        return self._GetOption('J7mVgBkdVG4Cub8JHiEiexPyY6F3gbLP5jRUHWc4PCFVklChlR')

    def GetAccessKey(self):
        return self._GetOption('2905925147-96wHh12umgZg8fUfOf93LVqrEK0F35M13pl4xUN')

    def GetAccessSecret(self):
        return self._GetOption('TlZvlQ5C2X7bdkYXiE4IUXjHWG8Ba4S0TG9yTJ7I1Uqtb')
